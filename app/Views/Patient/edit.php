...
<?= $this->section('data'); ?>
   ...
   <h2 class="data-heading mb-3">Edit Patient</h2>
   ...
   <div class="registration-form__form" >
           <form method="post" action="/patient/edit/<?= $currentPatient['id'] ?>" >
             <div class="row registration-space-y">   
               <div class="col">
                 <input type="text" name="first_name" required value="<?= set_value('first_name', $currentPatient['first_name'])?>" class="form-control" placeholder="First name" aria-describedby="firstname">
                </div>
               <div class="col">
                 <input type="text" name="middle_name"  value="<?= set_value('middle_name', $currentPatient['middle_name'])?>" class="form-control" placeholder="Middle name" aria-describedby="Middle name">
                </div>
                <div class="col">
                   <input type="text" name="sir_name" required value="<?= set_value('sir_name', $currentPatient['sir_name'])?>" class="form-control" placeholder="Sir name" aria-describedby="Sir name">
                </div>
             </div><!-- /row -->
            ...
            <div class="row registration-space-y">   
                ...
                <div class="col">
                    <input type="date" required title="Date of Birth" name="birth_date" value="<?= set_value('birth_date', $currentPatient['birth_date']) ?>" class="form-control" placeholder="Date of Birth" aria-describedby="Date of Birth">
                ...
                <div class="w-100" >
                  <select class="form-control" name="gender" id="gender">
                    ...
                    <option value="Male" <?= set_value('gender', $currentPatient['gender']) == 'Male'? 'selected': '' ?> >Male</option>
                    <option value="Female" <?= set_value('gender', $currentPatient['gender']) == 'Female'? 'selected': '' ?>>Female</option>
                  </select>
                </div>
              </div> <!-- /col -->
              <div class="col">
                 <input type="text" name="phone_no" value="<?= set_value('phone_no', $currentPatient['phone_no']) ?>"  class="form-control" placeholder="Phone number" aria-describedby="Phone number">
               </div>
            </div><!-- /row -->
            ...
            <div class="registration-space-y">
                ...
                <div class="row"> 
                    <div class="col">
                      <input type="text" required name="next_kin_name" value="<?= set_value('next_kin_name', $currentPatient['next_kin_name']) ?>" class="form-control" placeholder="next kin full name"  aria-describedby="next kin full name">
                    </div>
                    <div class="col">
                      <input type="text" required name="next_kin_relationship" value="<?= set_value('next_kin_relationship', $currentPatient['next_kin_relationship']) ?>" class="form-control" placeholder="next kin relationship "  aria-describedby="next kin relationship">
                    </div>
                    <div class="col">
                      <input type="text" required name="next_kin_phone" value="<?= set_value('next_kin_phone', $currentPatient['next_kin_phone']) ?>" class="form-control" placeholder="next kin phone number"  aria-describedby="next kin phone number">
                    </div>
                </div>
            ...
            <div class="registration-space-y">
                ...
                <div class="row">
                  <div class="col">
                    <div class="w-100" >
                        <?php 
                            $patient_character =  empty($patientFile) ? '' : $patientFile['patient_character'] ;
                        ?>
                            <select class="form-control" name="pcharacter" id="pcharacter">
                              <option value=""> Is Outpatient / Outsider? </option>
                              <option value="outpatient" <?= set_value('pcharacter', $patient_character) == 'outpatient'? 'selected': '' ?> >OutPatient</option>
                              <option value="outsider" <?= set_value('pcharacter', $patient_character) == 'outsider'? 'selected': '' ?>>Outsider</option>
                            </select>
                    </div>
                  </div><!-- /col-6 -->
                  <div class="col"></div>
           ...
           <?php } ?>
            ...
            <div class="row mt-6">
                 ...
                 <div class="col d-flex justify-content-end">
                     <button class="btn btn-success btn-sm " style="width: 8rem;"> Save</button>
                </div> 
            </div><!-- /row -->
         </form><!-- /form -->
