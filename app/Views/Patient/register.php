...
<div class="data-layout my-2 p-3 bg-white">
   ...
   <div class="registration-form__form" >
           <form method="post" action="/patient/register" >
            ...
            <div class="row registration-space-y">   
                <div class="col">
                   <input type="text" name="sir_name" value="<?= set_value('sir_name')?>" class="form-control" placeholder="Sir name" aria-describedby="Sir name">
                </div>
                <div class="col">
                    <input type="date" title="Date of Birth" name="birth_date" value="<?= set_value('birth_date') ?>" class="form-control" placeholder="Date of Birth" aria-describedby="Date of Birth">
              ...
              <div class="col d-flex align-items-center">
                <div class="form-check" style="margin-right: 19px;">
                  <label class="form-check-label">
                    <input type="radio" class="form-check-input" name="gender" value="Male" <?= set_value('gender') == 'Male'? 'checked': '' ?> />
                    Male
                  </label>
                </div>
                <div class="form-check">
                  <label class="form-check-label">
                    <input type="radio" class="form-check-input" name="gender" value="Female" <?= set_value('gender') == 'Female'? 'checked': '' ?> />
                    Female
                  </label>
                </div>
              </div><!-- /check-box-group -->
            ...
            <div class="registration-space-y">
                ...
                <div class="row"> 
                    <div class="col">
                      <input type="text" name="next_kin_name" class="form-control" placeholder="next kin name"  aria-describedby="next kin name">
                    </div>
                    <div class="col">
                      <input type="text" name="next_kin_relationship" class="form-control" placeholder="next kin relationshipd"  aria-describedby="next kin relationship">
                    </div>
                </div>
                <div class="row mt-3"> 
                    <div class="col">
                      <input type="text" name="next_kin_phone" class="form-control" placeholder="next kin phone number"  aria-describedby="next kin phone number">
                    </div>
                </div>
