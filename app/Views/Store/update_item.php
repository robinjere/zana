...
<div class="data-layout my-2 p-3 bg-white">
  ...
  <!-- <ul class="data-nav d-flex">
     <li class="py-2 me-3 "> <a href="/store/items">Drugs in store</a>  </li>
     ...
     <!-- <?php print_r($item); ?> -->
         <form method="post" >
           ...
           <div class="registration-space-y">
             ...
             <div class="col">
               <input type="number" required  min="0" step="0.01" name="selling_price" value="<?= set_value('selling_price', $item['selling_price'])?>" class="form-control" placeholder="Selling Price" aria-describedby="Selling Price">
              </div>
           </div><!-- /row -->
           <div class="row registration-space-y">   
             <div class="col">
          ...
          <div class="row registration-space-y">   
              <div class="col">
                  <textarea name="description" row="2" col="4" value="<?= set_value('description', $item['description']) ?>" class="form-control" placeholder="Description"><?= set_value('description', $item['description']) ?></textarea>
              </div>
          </div><!-- /row -->
