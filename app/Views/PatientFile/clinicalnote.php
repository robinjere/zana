   ...
   <form action="">
      ...
      <div class="my-3 note-box">
         <div class="d-flex justify-content-end mb-2">
            <button class="btn btn-sm btn-success add-note"> add clinical note </button>
         </div>
        ...
        <textarea class="form-control pt-5 pb-3" disabled id="note" >One of the largest importers of ceramic and porcelain wall and floor tiles from Spain, quality and stylish sanitary ware and mixers from Germany. 0745523092</textarea>
     </div><!-- /my-3 -->
