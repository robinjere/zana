     ...
     <div class="registration-form__form">
           <form method="post">
             ...
             <div class="row registration-space-y">   
               <div class="col">
                 <textarea name="description" value="<?= set_value('description')?>" id="" cols="30" rows="10" class="form-control" placeholder="Description" aria-describedby="description"></textarea>
                </div>
               <div class="col">
                 <input type="number" min="0" step="0.01" name="amount" value="<?= set_value('amount')?>" class="form-control" placeholder="amount" aria-describedby="amount">
                </div>
             </div><!-- /row -->
