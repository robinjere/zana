     ...
     <div class="registration-form__form">
           <form method="post">
             <div class="row registration-space-y">   
               <div class="col">
                 <textarea name="description" id="" cols="30" rows="10" class="form-control" placeholder="Description" aria-describedby="description"> <?= set_value('description', $expense['description']) ?></textarea>
                </div>
               <div class="col">
                 <input type="number" min="0" step="0.01" name="amount" value="<?= set_value('amount', $expense['amount']) ?>" class="form-control" placeholder="amount" aria-describedby="amount">
                </div>
             </div><!-- /row -->
            <div class="row mt-3">
                 <div class="col">
                     <a href="/expense/list" class="btn btn-warning btn-rounded"> Cancel </a>
                </div>
                 <div class="col d-flex justify-content-end">
                     <button class="btn btn-primary btn-rounded" style="width: 8rem;"> Edit </button>
                </div>
            </div><!-- /row -->
         </form><!-- /form -->
